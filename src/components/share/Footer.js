...
const Footer = () => {
  ...
  const year = date.getFullYear()
    return (
        <footer className="footer footer-center py-10 bg-black text-base-content rounded">
        <div className="grid grid-flow-col gap-4">
          <Link to='/' className="link link-hover">Blog page</Link> 
        ...
        <div>
          <p>Copyright © {year} - All right reserved by <span className=' text-primary font-bold'>Cycle Home</span></p>
        </div>
      </footer>
    );
};
